...
public class PacketHologram {
    ...
    public PacketHologram(GuardianLIB guardianLIB, List<Player> players, Location location, String holoPrivateID, String[] lines) {
    ...
    public PacketHologram(GuardianLIB guardianLIB, List<Player> players, Location location, String holoPrivateID, List<String> lines) {
        this.guardianLIB = guardianLIB;
        this.holoLocation = location;
        this.holoPrivateID = holoPrivateID;
        this.players = players;
    ...
    public PacketHologram(GuardianLIB guardianLIB, Player[] players, Location location, String holoPrivateID, String[] lines) {
        this.guardianLIB = guardianLIB;
        this.holoLocation = location;
        this.holoPrivateID = holoPrivateID;
    ...
    public PacketHologram(GuardianLIB guardianLIB, Player[] players, Location location, String holoPrivateID, List<String> lines) {
        this.guardianLIB = guardianLIB;
        this.holoLocation = location;
        this.holoPrivateID = holoPrivateID;
        this.players = Arrays.asList(players);
    ...
    public void spawn() {
        ...
        for (String line : this.holoLines) {
            ...
            guardianLIB.getNMS().spawnHologram(this.players,holoPrivateID + "-" + lineID,line,holoLineLocation);
    ...
    public void update() {
        for (int i = 0; i < this.holoLines.size(); i++) {
            guardianLIB.getNMS().updateHologramText(this.players,holoPrivateID + "-" + i,this.holoLines.get(i));
        }
    }

    public void delete() {
        for (int i = 0; i < this.holoLines.size(); i++) {
            guardianLIB.getNMS().deleteHologram(this.players,holoPrivateID + "-" + i);
        }
    }
